...
function generateTerms(title, channel) {
  const channelPart = channel === 'online' ? 'Apply this offer during checkout on the website.' : 'Show this offer and your student ID at the counter.'
...
console.log(`✅ ${shuffledOffers.length} context-aware offers generated and saved to ${filePath}`)
